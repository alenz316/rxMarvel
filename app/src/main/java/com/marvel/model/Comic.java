...
import com.marvel.model.ComicDate;
import com.marvel.model.ComicPrice;
...
import com.marvel.model.TextObject;
...
public class Comic {
  ...
  **/
  ...
  public Comic modified(LocalDate modified) {
  ...
  **/
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    Comic comic = (Comic) o;
    return ObjectUtils.equals(this.id, comic.id) &&
    ObjectUtils.equals(this.digitalId, comic.digitalId) &&
    ObjectUtils.equals(this.title, comic.title) &&
    ObjectUtils.equals(this.issueNumber, comic.issueNumber) &&
    ObjectUtils.equals(this.variantDescription, comic.variantDescription) &&
    ObjectUtils.equals(this.description, comic.description) &&
    ObjectUtils.equals(this.modified, comic.modified) &&
    ObjectUtils.equals(this.isbn, comic.isbn) &&
    ObjectUtils.equals(this.upc, comic.upc) &&
    ObjectUtils.equals(this.diamondCode, comic.diamondCode) &&
    ObjectUtils.equals(this.ean, comic.ean) &&
    ObjectUtils.equals(this.issn, comic.issn) &&
    ObjectUtils.equals(this.format, comic.format) &&
    ObjectUtils.equals(this.pageCount, comic.pageCount) &&
    ObjectUtils.equals(this.textObjects, comic.textObjects) &&
    ObjectUtils.equals(this.resourceURI, comic.resourceURI) &&
    ObjectUtils.equals(this.urls, comic.urls) &&
    ObjectUtils.equals(this.series, comic.series) &&
    ObjectUtils.equals(this.variants, comic.variants) &&
    ObjectUtils.equals(this.collections, comic.collections) &&
    ObjectUtils.equals(this.collectedIssues, comic.collectedIssues) &&
    ObjectUtils.equals(this.dates, comic.dates) &&
    ObjectUtils.equals(this.prices, comic.prices) &&
    ObjectUtils.equals(this.thumbnail, comic.thumbnail) &&
    ObjectUtils.equals(this.images, comic.images) &&
    ObjectUtils.equals(this.creators, comic.creators) &&
    ObjectUtils.equals(this.characters, comic.characters) &&
    ObjectUtils.equals(this.stories, comic.stories) &&
    ObjectUtils.equals(this.events, comic.events);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(id, digitalId, title, issueNumber, variantDescription, description, modified, isbn, upc, diamondCode, ean, issn, format, pageCount, textObjects, resourceURI, urls, series, variants, collections, collectedIssues, dates, prices, thumbnail, images, creators, characters, stories, events);
  }
